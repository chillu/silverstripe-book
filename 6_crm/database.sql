...
--
-- Host: localhost
-- Generation Time: Jul 14, 2009 at 10:50 PM
...
INSERT INTO `CollectionPage` (`ID`, `CollectionModelClass`, `CollectionControllerClass`) VALUES
...
INSERT INTO `CollectionPage_Live` (`ID`, `CollectionModelClass`, `CollectionControllerClass`) VALUES
(8, 'Developer', 'CollectionController'),
(14, 'Reference', 'CollectionController');
...
INSERT INTO `CollectionPage_versions` (`ID`, `RecordID`, `Version`, `WasPublished`, `AuthorID`, `PublisherID`, `CollectionModelClass`, `CollectionControllerClass`) VALUES
...
INSERT INTO `Developer` (`ID`, `Region`, `Introduction`) VALUES
(3, 'Nelson', NULL),
...
INSERT INTO `Developer_Skills` (`ID`, `DeveloperID`, `SkillID`) VALUES
(2, 2, 4),
(3, 2, 5);
...
(1, 'Member', '2009-01-17 17:20:32', '2009-07-14 22:49:06', 'Admin', 'Admin', 'admin', 'm9x7zgns5zkcs840o0o4gko08kw84gw', NULL, 5, '2009-07-14 22:50:12', 0, NULL, NULL, 0, 'sha1', '91d4m443o18ogskcg48sk4ww04wccg8o8wgck04', NULL, NULL, 'en_US'),
...
INSERT INTO `MultiFormSession` (`ID`, `ClassName`, `Created`, `LastEdited`, `Hash`, `IsComplete`, `SubmitterID`, `CurrentStepID`) VALUES
...
INSERT INTO `MultiFormStep` (`ID`, `ClassName`, `Created`, `LastEdited`, `Data`, `SessionID`) VALUES
...
INSERT INTO `Page` (`ID`, `SideBarID`) VALUES
(1, 5),
(2, 0),
(3, 7),
(4, 1),
...
INSERT INTO `Page_Live` (`ID`, `SideBarID`) VALUES
(1, 5),
(2, 0),
(3, 7),
(4, 1),
...
INSERT INTO `Page_versions` (`ID`, `RecordID`, `Version`, `WasPublished`, `AuthorID`, `PublisherID`, `SideBarID`) VALUES
(1, 1, 1, 0, 1, 0, 0),
(2, 2, 1, 0, 1, 0, 0),
(3, 3, 1, 0, 1, 0, 0),
(4, 4, 1, 0, 1, 0, 1),
...
INSERT INTO `Reference` (`ID`, `ClassName`, `Created`, `LastEdited`, `URL`, `Title`, `ScreenshotImageID`, `DeveloperID`) VALUES
...
(9, 'JobCategory', '2009-01-17 17:43:14', '2009-07-14 22:49:30', 'programming', 'Programming', NULL, '<p></p>', 'Programming', NULL, NULL, NULL, 1, 1, NULL, 0, 1, NULL, 0, 0, 'Published', NULL, 'Inherit', 'Inherit', NULL, 2, 9),
...
(11, 'JobCategory', '2009-01-17 17:47:33', '2009-07-14 22:49:50', 'content-creation', 'Content Creation', NULL, '<p></p>', 'Content Creation', NULL, NULL, NULL, 1, 1, NULL, 0, 3, NULL, 0, 0, 'Published', NULL, 'Inherit', 'Inherit', NULL, 2, 7),
(12, 'JobCategory', '2009-01-17 17:47:48', '2009-07-14 22:49:58', 'other', 'Other', NULL, '<p></p>', 'Other', NULL, NULL, NULL, 1, 1, NULL, 0, 4, NULL, 0, 0, 'Published', NULL, 'Inherit', 'Inherit', NULL, 2, 7),
...
(92, 9, 8, 0, 1, 0, 'JobCategory', '2009-01-17 17:43:14', '2009-07-14 22:49:30', 'programming', 'Programming', NULL, '<p></p>', 'Programming', NULL, NULL, NULL, 1, 1, NULL, 0, 1, NULL, 0, 0, 'Saved (update)', NULL, 'Inherit', 'Inherit', NULL, 2),
(93, 9, 9, 1, 1, 1, 'JobCategory', '2009-01-17 17:43:14', '2009-07-14 22:49:30', 'programming', 'Programming', NULL, '<p></p>', 'Programming', NULL, NULL, NULL, 1, 1, NULL, 0, 1, NULL, 0, 0, 'Published', NULL, 'Inherit', 'Inherit', NULL, 2),
(94, 11, 6, 0, 1, 0, 'JobCategory', '2009-01-17 17:47:33', '2009-07-14 22:49:50', 'content-creation', 'Content Creation', NULL, '<p></p>', 'Content Creation', NULL, NULL, NULL, 1, 1, NULL, 0, 3, NULL, 0, 0, 'Saved (update)', NULL, 'Inherit', 'Inherit', NULL, 2),
(95, 11, 7, 1, 1, 1, 'JobCategory', '2009-01-17 17:47:33', '2009-07-14 22:49:50', 'content-creation', 'Content Creation', NULL, '<p></p>', 'Content Creation', NULL, NULL, NULL, 1, 1, NULL, 0, 3, NULL, 0, 0, 'Published', NULL, 'Inherit', 'Inherit', NULL, 2),
(96, 12, 6, 0, 1, 0, 'JobCategory', '2009-01-17 17:47:48', '2009-07-14 22:49:58', 'other', 'Other', NULL, '<p></p>', 'Other', NULL, NULL, NULL, 1, 1, NULL, 0, 4, NULL, 0, 0, 'Saved (update)', NULL, 'Inherit', 'Inherit', NULL, 2),
(97, 12, 7, 1, 1, 1, 'JobCategory', '2009-01-17 17:47:48', '2009-07-14 22:49:58', 'other', 'Other', NULL, '<p></p>', 'Other', NULL, NULL, NULL, 1, 1, NULL, 0, 4, NULL, 0, 0, 'Published', NULL, 'Inherit', 'Inherit', NULL, 2);
...
INSERT INTO `Skill` (`ID`, `ClassName`, `Created`, `LastEdited`, `Title`) VALUES
...
--
-- Table structure for table `_obsolete_EditableLiteralField`
--

DROP TABLE IF EXISTS `_obsolete_EditableLiteralField`;
CREATE TABLE IF NOT EXISTS `_obsolete_EditableLiteralField` (
  `ID` int(11) NOT NULL auto_increment,
  `Content` mediumtext character set utf8,
  PRIMARY KEY  (`ID`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
--
-- Dumping data for table `_obsolete_EditableLiteralField`
--
...
CREATE TABLE IF NOT EXISTS `_obsolete_RegistrationPage` (
  `ID` int(11) NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS `_obsolete_RegistrationPage_Live` (
  `ID` int(11) NOT NULL auto_increment,
  `ThankYouText` mediumtext character set utf8,
  PRIMARY KEY  (`ID`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `_obsolete_RegistrationPage_versions` (
  `ID` int(11) NOT NULL auto_increment,
  `RecordID` int(11) NOT NULL default '0',
  `Version` int(11) NOT NULL default '0',
  `WasPublished` tinyint(1) unsigned NOT NULL default '0',
